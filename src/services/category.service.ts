...
export const categoryService = {
    ...
    //     const [products, totalData] = await Promise.all([ productRepository.findAll({...query, limit, offset: skip, category_id: category.id, cursor: {}}), productRepository.countAll({...query, limit, offset: skip, category_id: category.id, cursor: {}}) ])
    //     const totalPages = Math.ceil(totalData / limit)
